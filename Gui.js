...
function drawStartScreen() {
  ...
  textSize(25);
  switch (
    bob.difficultyFactor // Change difficulty factor to a string to visualize in menu
  ) {
    case 0.25:
      difficulty = "Easy";
      break;
...
function drawGameOver() {
  ...
  textSize(30);
  text(
    "Press R to restart the game, W to go to main menu",
    width / 2,
    height / 2 + 50
  );
...
// Draw the background, sun, and clouds
